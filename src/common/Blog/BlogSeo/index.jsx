...
export default function BlogSeo({ blog }) {
  ...
  const canonicalPath = seo.canonicalUrl || (blog?.slug ? `/blog/${blog.slug}` : undefined);
  const canonicalUrl = canonicalPath?.startsWith("http") ? canonicalPath : canonicalPath ? `https://www.pixeleyehospitals.com${canonicalPath}` : undefined;
