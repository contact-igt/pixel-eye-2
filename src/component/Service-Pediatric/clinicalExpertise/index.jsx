...
const PediatricClinicalExpertise = () => {
  const { clinicalExpertise: data } = SERVICE_PEDIATRIC_CONTENT;
  ...
  return (
    <section
      ...
      aria-labelledby="pediatric-clinical-expertise-title"
    >
      <div className={styles["clinical-expertise__inner"]}>
        <div className={styles["clinical-expertise__header"]}>
          <h2 id="pediatric-clinical-expertise-title">{data.title}</h2>
          <p>{data.intro}</p>
        </div>
