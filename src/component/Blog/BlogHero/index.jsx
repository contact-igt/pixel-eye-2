...
export default function BlogHero({ variant = "template-1", data = {} }) {
  const isTemplateTwo = variant === "template-2";

  return (
    <section className={`${styles.hero} ${isTemplateTwo ? styles.templateTwo : styles.templateOne}`}>
      ...
      <div className={styles.content}>
        <div className={styles.breadcrumb}>Home &gt; Blog &gt; {data.category}</div>
