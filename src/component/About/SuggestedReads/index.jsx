          ...
          {featuredRead ? (
            <article className={styles.featuredCard}>
              ...
              <div className={styles.featuredBody}>
                ...
                <Link href={featuredRead.href} className={styles.readMore} aria-label={`Read more: ${featuredRead.title}`}>
            ...
            {sideReads.map((item) => (
              <article key={item.id} className={styles.sideCard}>
                ...
                <div className={styles.sideContent}>
                  ...
                  <Link href={item.href} className={styles.readMore} aria-label={`Read more: ${item.title}`}>
                    <span className={styles.readLabel}>Read More</span>
                    <span className={styles.readIcon}>
                      <ArrowUpRight size={20} strokeWidth={2.1} />
                    </span>
